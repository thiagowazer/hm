const ownerNumber = ["556194452893@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '556194452893' 
...
const blockedmsg = '*😜 Seu número esta bloqueado, ou seja não estou ouvindo você 😜*'
...
const banmsglink = 'Divulgou aqui já sabe, prepara o café ☕'
...
+ 'FN:ᬊ͜͡𝐇𝐈𝐃𝐑𝐀ꪶ♾ꫂ𝐌𝐔𝐆𝐄𝐍\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=556796005372:+55 67 9600-5372\n' 
+ 'END:VCARD'
